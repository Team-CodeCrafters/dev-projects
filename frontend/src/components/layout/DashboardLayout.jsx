  ...
  return (
    <div className="dark:bg-black-medium flex h-screen w-screen flex-col">
      ...
      <div className="relative flex w-[100vw] flex-1 justify-start overflow-hidden">
        ...
        <div
          className={`dark:bg-black-medium custom-scrollbar scrollbar-gutter-stable w-full items-center justify-center overflow-auto bg-white pt-3 transition-all md:pt-6 dark:text-white ${
