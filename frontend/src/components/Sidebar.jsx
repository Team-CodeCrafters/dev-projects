...
const SidebarElement = ({ Icon, name, href }) => {
  ...
  return (
    <Link to={href} className="group">
      <li className="bg-white-medium font-heading dark:hover:bg-black-light dark:bg-black-light dark:text-white-light m-2 mt-4 flex cursor-pointer items-center justify-start gap-4 rounded-md p-3 transition-all duration-300 ease-in-out hover:bg-gray-100">
